...
const itemsArray = [
  ...
  // id 1210 seems buggy because it is yellow but called Grand Tranquil Scene
  {
    ...
    color: RelicSlotColor.Yellow,
    ids: [
      120, 123, 126, 220, 223, 226, 1210, 1220, 1450, 1470, 1510, 17162, 17182,
      18162, 18172, 18182, 19162, 19172, 19182, 20020, 20023, 20026, 20162,
      20172, 21162, 21172, 21182, 22162, 22172, 22182, 24162, 24172, 24182,
      1000202, 1000212, 1000222, 1001202, 1001212, 1001222, 1002202, 1002212,
      1002222, 1003202, 1003212, 1003222, 1004202, 1004212, 1004222, 1005202,
      1005212, 1005222, 1006202, 1006212, 1006222, 1007202, 1007212, 1007222,
    ],
    type: ItemType.Relic,
  },
  {
    ...
    color: RelicSlotColor.Green,
    ids: [
      129, 132, 135, 229, 232, 235, 1200, 1270, 1310, 1420, 1430, 1490, 17262,
      17272, 17282, 18262, 18272, 18282, 19272, 19282, 20029, 20032, 20035,
      21262, 21282, 22262, 22272, 22282, 23262, 23272, 23282, 24262, 24272,
      24282, 1000302, 1000312, 1000322, 1001302, 1001312, 1001322, 1002302,
      1002312, 1002322, 1003302, 1003312, 1003322, 1004302, 1004312, 1004322,
      1005302, 1005312, 1005322, 1006302, 1006312, 1006322, 1007302, 1007312,
      1007322, 1008312,
    ],
    type: ItemType.Relic,
  },
  ...
  },
  {
    ...
    ids: [
      ...
      2003001, 2003011, 2003021, 2013011,
    ],
    type: ItemType.DeepRelic,
  },
  {
    ...
    ids: [
      ...
      2002002, 2002012, 2002022, 2003002, 2003012, 2003022, 2010012, 2013012,
      2013022,
    ],
    type: ItemType.DeepRelic,
  },
  ...
  },
  {
    ...
    ids: [
      ...
      2003101, 2003111, 2003121, 2013121,
    ],
    type: ItemType.DeepRelic,
  },
  {
    ...
    ids: [
      ...
      2002102, 2002112, 2002122, 2003102, 2003112, 2003122, 2010112, 2011112,
      2012102,
    ],
    type: ItemType.DeepRelic,
  },
  ...
  },
  {
    ...
    ids: [
      ...
      2003201, 2003211, 2003221, 2013211,
    ],
    type: ItemType.DeepRelic,
  },
  {
    ...
    ids: [
      ...
      2002202, 2002212, 2002222, 2003202, 2003212, 2003222, 2010222, 2011222,
      2013202, 2013222,
    ],
    type: ItemType.DeepRelic,
  },
  ...
  },
  {
    ...
    ids: [
      ...
      2003301, 2003311, 2003321, 2013301,
    ],
    type: ItemType.DeepRelic,
  },
  {
    ...
    ids: [
      ...
      2002302, 2002312, 2002322, 2003302, 2003312, 2003322, 2010312, 2011302,
      2013302, 2013322,
    ],
    type: ItemType.DeepRelic,
  },
