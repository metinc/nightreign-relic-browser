...
const itemsArray = [
  ...
  },
  {
    ...
    color: RelicSlotColor.Red,
    ids: [
      100, 103, 106, 203, 1000, 11003, 11004, 20000, 20003, 20006, 1000000,
      1000010, 1000020, 1001000, 1001010, 1001020, 1002000, 1002010, 1002020,
      1003000, 1003010, 1003020, 1004000, 1004010, 1004020, 1005000, 1005010,
      1005020, 1006000, 1006010, 1006020, 1007000, 1007010, 1007020,
    ],
    type: ItemType.Relic,
  },
  {
    ...
    color: RelicSlotColor.Blue,
    ids: [
      109, 112, 115, 209, 1010, 12005, 12006, 19080, 20009, 20012, 20015, 20060,
  ...
  },
  {
    ...
    color: RelicSlotColor.Yellow,
    ids: [
      118, 121, 124, 221, 1020, 1050, 12004, 17160, 19160, 20018, 20021, 20024,
  ...
  },
  {
    ...
    color: RelicSlotColor.Green,
    ids: [
      127, 130, 133, 230, 1030, 12007, 20027, 20030, 20033, 1000300, 1000310,
  ...
  },
  {
    ...
    ids: [
      ...
      1500, 16962, 16972, 16982, 17962, 17972, 17982, 18962, 18972, 18982,
      19962, 19972, 19982, 20002, 20005, 20008, 20962, 20972, 20982, 21962,
      21972, 21982, 22972, 23962, 23972, 23982, 1000002, 1000012, 1000022,
      1001002, 1001012, 1001022, 1002002, 1002012, 1002022, 1003002, 1003012,
      1003022, 1004002, 1004012, 1004022, 1005002, 1005012, 1005022, 1006002,
      1006012, 1006022, 1007002, 1007012, 1007022, 1008012, 1008022,
    ],
    type: ItemType.Relic,
  },
  {
    ...
    color: RelicSlotColor.Blue,
    ids: [
      111, 114, 117, 211, 214, 217, 1190, 1230, 1240, 1400, 1460, 1520, 18072,
      18082, 19062, 19072, 19082, 20011, 20014, 20017, 20062, 20072, 20082,
      21062, 21072, 21082, 22062, 22072, 22082, 23062, 23072, 23082, 24062,
  ...
  },
  {
    ...
    color: RelicSlotColor.Yellow,
    ids: [
      120, 123, 126, 220, 223, 226, 1220, 1450, 1470, 1510, 17162, 17182, 18162,
      18172, 18182, 19162, 19172, 19182, 20020, 20023, 20026, 20162, 20172,
      21162, 21172, 21182, 22162, 22172, 22182, 24162, 24172, 24182, 1000202,
  ...
  },
  {
    ...
    color: RelicSlotColor.Green,
    ids: [
      129, 132, 135, 229, 232, 235, 1200, 1210, 1270, 1310, 1420, 1430, 1490,
      17262, 17272, 17282, 18262, 18272, 18282, 19272, 19282, 20029, 20032,
      20035, 21262, 21282, 22262, 22272, 22282, 23262, 23272, 23282, 24262,
      24272, 24282, 1000302, 1000312, 1000322, 1001302, 1001312, 1001322,
      1002302, 1002312, 1002322, 1003302, 1003312, 1003322, 1004302, 1004312,
      1004322, 1005302, 1005312, 1005322, 1006302, 1006312, 1006322, 1007302,
      1007312, 1007322, 1008312,
    ],
    type: ItemType.Relic,
  },
  {
    ...
    color: RelicSlotColor.Red,
    ids: [
      101, 104, 107, 204, 1040, 1080, 1110, 1120, 16961, 16971, 17961, 17971,
      17981, 18971, 19961, 19981, 20001, 20004, 20007, 20961, 20971, 20981,
      21961, 21971, 21981, 22961, 22981, 23961, 23971, 23981, 1000001, 1000011,
  ...
  },
  {
    ...
    color: RelicSlotColor.Blue,
    ids: [
      110, 113, 116, 216, 1070, 1160, 1170, 17061, 17071, 17081, 18071, 18081,
      19071, 19081, 20010, 20013, 20016, 20061, 20071, 20081, 21061, 21081,
      22071, 22081, 23061, 23071, 23081, 24061, 24071, 24081, 1000101, 1000111,
  ...
  },
  {
    ...
    color: RelicSlotColor.Yellow,
    ids: [
      119, 122, 125, 225, 1140, 1150, 17171, 17181, 18161, 18171, 18181, 19161,
  ...
  },
  {
    ...
    color: RelicSlotColor.Green,
    ids: [
      128, 131, 134, 231, 1060, 1090, 1100, 1130, 17261, 17271, 17281, 18261,
      18271, 18281, 19261, 19281, 20028, 20031, 20034, 20261, 21261, 21271,
      21281, 22271, 22281, 23261, 23271, 23281, 24261, 1000301, 1000311,
      ...
      1006301, 1006311, 1006321, 1007301, 1007311, 1007321,
    ],
    type: ItemType.Relic,
  },
  {
    ...
    color: RelicSlotColor.Red,
    ids: [2000010, 2003000, 2003010, 2003020, 2013020],
    type: ItemType.DeepRelic,
  },
  {
    key: "deepDelicateDrizzlyScene",
    color: RelicSlotColor.Blue,
    ids: [2000100, 2000110, 2003100, 2003120, 2013100],
    type: ItemType.DeepRelic,
  },
  {
  ...
  },
  {
    ...
    color: RelicSlotColor.Green,
    ids: [2000320, 2003300, 2003320, 2010320],
    type: ItemType.DeepRelic,
  },
  {
    ...
    color: RelicSlotColor.Red,
    ids: [
      2000002, 2000012, 2000022, 2001002, 2001012, 2001022, 2002002, 2003012,
      2003022, 2010012, 2013012, 2013022,
    ],
    type: ItemType.DeepRelic,
  },
  {
    ...
    color: RelicSlotColor.Blue,
    ids: [
      2000112, 2001112, 2001122, 2002102, 2003102, 2003112, 2003122, 2010112,
      2011112, 2012102,
    ],
    type: ItemType.DeepRelic,
  },
  {
    ...
    color: RelicSlotColor.Yellow,
    ids: [
      2000202, 2000212, 2000222, 2001202, 2001212, 2002202, 2002212, 2003202,
      2003212, 2003222, 2010222, 2011222, 2013202, 2013222,
    ],
    type: ItemType.DeepRelic,
  },
  {
    ...
    color: RelicSlotColor.Green,
    ids: [
      2000302, 2000312, 2000322, 2001302, 2001322, 2002302, 2002312, 2003302,
      2003312, 2003322, 2010312, 2011302, 2013302, 2013322,
    ],
    type: ItemType.DeepRelic,
  },
  {
    ...
    color: RelicSlotColor.Red,
    ids: [
      2000001, 2000011, 2000021, 2001001, 2001021, 2003001, 2003011, 2003021,
      2013011,
    ],
    type: ItemType.DeepRelic,
  },
  {
    ...
    color: RelicSlotColor.Blue,
    ids: [
      2000101, 2000111, 2000121, 2001101, 2001111, 2001121, 2003101, 2003121,
      2013121,
    ],
    type: ItemType.DeepRelic,
  },
  {
    ...
    color: RelicSlotColor.Yellow,
    ids: [2000201, 2000211, 2000221, 2001211, 2003201, 2003211, 2013211],
    type: ItemType.DeepRelic,
  },
  {
    ...
    color: RelicSlotColor.Green,
    ids: [
      2000301, 2000311, 2000321, 2001301, 2001311, 2003301, 2003311, 2013301,
    ],
    type: ItemType.DeepRelic,
  },
  {
